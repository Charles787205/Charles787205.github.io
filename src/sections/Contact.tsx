...
const Contact = () => {
  ...
  return (
    <section id="contact" className="min-h-screen bg-slate-900 py-20 flex items-center">
        ...
        >
          ...
          <div className="grid md:grid-cols-3 gap-8 mb-16">
            <motion.a
              ...
              whileHover={{ y: -5 }}
              className="bg-slate-800 p-8 rounded-2xl text-center hover:bg-slate-700 transition-colors group"
            >
              <div className="w-16 h-16 bg-slate-700 rounded-full flex items-center justify-center mx-auto mb-4 group-hover:bg-slate-600 transition-colors">
