...
const Contact = () => {
  ...
  return (
    <section id="contact" className="min-h-screen bg-gradient-to-b from-teal-50 via-emerald-50 to-white py-20 flex items-center relative overflow-hidden">
      {/* Animated Background */}
      <div className="absolute inset-0 overflow-hidden pointer-events-none">
        {particles.map((particle, i) => (
          <motion.div
            key={i}
            className="absolute w-2 h-2 bg-teal-300/50 rounded-full"
            style={{
              left: particle.left,
              top: particle.top,
            }}
        ...
        >
          ...
          <div className="grid md:grid-cols-3 gap-8 mb-16">
            <motion.a
              ...
              whileHover={{ y: -5 }}
              className="bg-white p-8 rounded-2xl text-center border border-gray-200 hover:border-teal-300 hover:shadow-lg transition-all group"
            >
              ...
              <p className="text-gray-600 text-sm">joviancharles1210@gmail.com</p>
            </motion.a>
            ...
            >
              ...
              <p className="text-gray-600 text-sm">+63 156 787 205</p>
            </motion.a>
            ...
            <motion.div
              ...
              className="bg-white p-8 rounded-2xl text-center border border-gray-200"
            >
              ...
              <p className="text-gray-600 text-sm">Davao City, Philippines</p>
            </motion.div>
          </div>
          ...
          >
            <div className="flex justify-center gap-6 mb-8">
              <motion.a
                ...
                className="w-12 h-12 bg-white rounded-full flex items-center justify-center border border-gray-200 hover:border-teal-300 hover:shadow-md transition-all"
              >
